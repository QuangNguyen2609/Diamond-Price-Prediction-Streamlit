...
st.write("This website is going to classify the type of diamonds based on several features such as cuts, size and clearness to decide which kind of diamond does this belong to")
st.header("II. Usage")
st.image("""https://www.thestreet.com/.image/ar_4:3%2Cc_fill%2Ccs_srgb%2Cq_auto:good%2Cw_1200/MTY4NjUwNDYyNTYzNDExNTkx/why-dominion-diamonds-second-trip-to-the-block-may-be-different.png""", 
            caption="Example image of a diamond", 
            width=600)
st.header('Enter the characteristics of the diamond:')


model = lightgbm.Booster(model_file='weights/lgbr.txt')
...
if st.button("Predict price"):
    ...
    st.success(f'The predicted price of the diamond is ${float(price):.2f} USD')